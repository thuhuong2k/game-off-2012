...
var BoxBlock, BoxObject, Camera, EmptyBlock, GamePlay, KeyboardController, LevelState, LevelView, LiftBlock, LiftObject, MouseController, Observable, PlatformBlock, Player, PlayerObject, SkyObject, SolidBlock, StaticLevelObject, View, createTextures, e3d, loadFilesUsing, loadImageFile, loadImageFiles, loadJsonFile, loadJsonFiles, loadResourceFiles, makeBackFace, makeBox, makeFrontFace, makeLeftFace, makeLidlessBox, makeQuad, makeRightFace, makeTopFace, mat, resource_dir, vec,
...
MouseController = (function() {
  ...
  function MouseController(canvas, camera) {
    var mouseDown, previousX, previousY, sensitivity;
    mouseDown = false;
    previousX = 0;
    previousY = 0;
    sensitivity = 0.01;
