...
var BoxBlock, BoxObject, EmptyBlock, GamePlay, KeyboardController, LevelState, LevelView, LiftBlock, LiftObject, Observable, PlatformBlock, SkyObject, SolidBlock, StaticLevelObject, View, boxMeshes, boxTextures, e3d, levelTextures, liftMeshes, liftTextures, loadImage, loadJson, loadTexture, loadTextures, makeBackFace, makeBox, makeFrontFace, makeLeftFace, makeLidlessBox, makeQuad, makeRightFace, makeTopFace, mat, resource_dir, setBoxTextures, setLevelTextures, setLiftTextures, setSkyTextures, skyMeshes, skyTextures, vec;
...
LevelState = function(levelData) {
  var block, blockArray, blockAt, blockBelow, depth, forEach, forEachBlock, forEachBlockInLayer, height, layer, row, width;
...
LevelView = function() {
  ...
  scene = new e3d.Scene;
  scene.camera = camera;
  loadTextures(['sky'], function(textures) {
    setSkyTextures(textures);
    return loadTextures(['wall', 'floor', 'platform'], function(textures) {
      setLevelTextures(textures);
      return loadTextures(['box'], function(textures) {
        setBoxTextures(textures);
        return loadTextures(['lift', 'lifttop'], function(textures) {
  ...
  this.update = function(levelState) {
    var boxGroup, center, levelModel, liftGroup, objects, skySphere;
...
SkyObject = function(x, y, z) {
  ...
  if (skyMeshes.length === 0) {
    skyMeshes[0] = null;
    loadJson('mod/sky.json', function(sky) {
