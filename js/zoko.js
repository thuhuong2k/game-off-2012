...
LevelState = function(levelData) {
  var block, blockArray, blockAt, blockBelow, depth, forEach, forEachBlock, forEachBlockInLayer, height, layer, player, row, width, x, y, z;
