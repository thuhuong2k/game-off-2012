...
var BoxBlock, BoxObject, EmptyBlock, GamePlay, KeyboardController, LevelState, LevelView, LiftBlock, LiftObject, Observable, PlatformBlock, SolidBlock, StaticLevelObject, View, boxMeshes, boxTextures, e3d, levelTextures, liftMeshes, liftTextures, loadImage, loadJson, loadTexture, loadTextures, makeBackFace, makeBox, makeFrontFace, makeLeftFace, makeLidlessBox, makeQuad, makeRightFace, makeTopFace, mat, resource_dir, setBoxTextures, setLevelTextures, setLiftTextures, vec;
...
LevelView = function() {
  ...
  this.update = function(levelState) {
    var boxGroup, levelModel, liftGroup, objects;
