...
var EmptyBlock, GamePlay, KeyboardController, LevelState, LevelView, Observable, PlatformBlock, SolidBlock, View, buildStaticLevelModel, e3d, loadTextures, makeBackFace, makeFrontFace, makeLeftFace, makeQuad, makeRightFace, makeTopFace, mat, vec;
...
LevelView = function() {
  var camera, currState, scene, staticModel;
...
buildStaticLevelModel = function(levelState) {
  ...
  return [new e3d.Mesh(ground), new e3d.Mesh(side), new e3d.Mesh(solidTop), new e3d.Mesh(platformTop)];
};
